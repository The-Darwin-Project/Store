"""Dashboard endpoint for Customer Management Service business metrics.

Uses shared DB reads across both domains (acceptable for logical split).
"""
...
async def get_dashboard(request: Request):
    ...
    try:
        with conn.cursor() as cur:
            ...
            # 3. Top 5 products by sales volume (shared DB read)
            cur.execute("""
            ...
            # 4. Low-stock alerts (shared DB read)
            cur.execute("""
