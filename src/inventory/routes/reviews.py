...
# 3. [Gotcha]: Validate product_id and customer_id existence before insert. Customer validation uses shared DB.
"""Product review endpoints for Inventory Service."""
...
async def create_review(product_id: str, review: ReviewCreate, request: Request) -> Review:
    ...
    try:
        with conn.cursor() as cur:
            ...
            # Validate customer exists (shared DB -- cross-domain read)
